                ...
                <div className="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5">
                  <div className="rounded overflow-hidden shadow-md bg-white">
                    ...
                    <div className="px-6 mt-16">
                      ...
                      <p className="text-center text-gray-600 text-base pt-3 font-normal">
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam eget sapien sit amet nunc accumsan consectetur. Curabitur euismod convallis neque, vitae placerat turpis interdum eget. Quisque auctor metus eu nulla consectetur, sed eleifend turpis 
                      fermentum. Ut euismod lorem vitae justo ullamcorper, quis sagittis nunc convallis. Integer sed elit id libero suscipit efficitur.
                      </p>
                      <div className="w-full flex justify-center pt-5 pb-5">
                        <a href="#" className="mx-5">
                          <div>
          ...
          <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 lg:gap-24 md:gap-10 gap-12 lg:px-20 md:py-12 md:px-6 py-9 px-4">
            ...
            <div className="flex space-x-4">
              ...
              <div>
                ...
                <p className=" text-base leading-6 font-normal text-gray-600 mt-3">
                  Contact us 24 hours a day at edintern.com
                </p>
              </div>
            </div>
