      ...
      <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
        ...
        <div className="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12 remove-flex-sm">
          <div className="w-full lg:w-6/12">
            ...
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam eget sapien sit amet nunc accumsan consectetur. Curabitur euismod convallis neque, vitae placerat turpis interdum eget. Quisque auctor metus eu nulla consectetur, sed eleifend turpis fermentum.
             Ut euismod lorem vitae justo ullamcorper, quis sagittis nunc convallis. Integer sed elit id libero suscipit efficitur.
             Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam eget sapien sit amet nunc accumsan consectetur. Curabitur euismod convallis neque, vitae placerat turpis interdum eget. Quisque auctor metus eu nulla consectetur, sed eleifend 
             turpis fermentum. Ut euismod lorem vitae justo ullamcorper, quis sagittis nunc convallis.
             Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam eget sapien sit amet nunc accumsan consectetur. Curabitur euismod convallis neque, vitae placerat turpis interdum eget. Quisque auctor metus eu nulla consectetur, sed eleifend
              turpis fermentum. Ut euismod lorem vitae justo ullamcorper, quis sagittis nunc convallis. Integer sed elit id libero suscipit efficitur. Integer sed elit id libero suscipit efficitur.
            </p>
          </div>
          <div className="w-full lg:w-6/12">
            <img
        ...
        <div className="flex lg:flex-row flex-col md:gap-14 gap-16 justify-between lg:mt-20 mt-16 remove-flex-sm">
          <div className="w-full lg:w-6/12">
            ...
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam eget sapien sit amet nunc accumsan consectetur. Curabitur euismod convallis neque, vitae placerat turpis interdum eget. Quisque auctor metus eu nulla consectetur, sed eleifend 
            turpis fermentum. Ut euismod lorem vitae justo ullamcorper, quis sagittis nunc convallis. Integer sed elit id libero suscipit efficitur.
